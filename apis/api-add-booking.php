...
if(empty($endDate)){ sendResponse(0, __LINE__, "Owner userId is missing!"); }

$sitterUserId = $_POST['sitterUserId'] ?? '';
if(empty($endDate)){ sendResponse(0, __LINE__, "Sitter userId is missing!"); }

//TODO clean the number from the dot . before saving

$bookingTypeId = $_POST['typeOption'] ?? '';
